...
class CRUDBase(Generic[ModelType, CreateSchemaType, UpdateSchemaType]):
    ...
    async def create(
        self, obj_in, session: AsyncSession, user: Optional[User] = None, commit=True
    ) -> ModelType:
    ...
    async def get_underinvested_objects(self, db_model, session: AsyncSession) -> List[ModelType]:
